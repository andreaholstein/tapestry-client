    ...
    return (
        <>
            <footer className="footer">
                <div className="footer__team-details">
                    <ul className="footer__our-team">
                        <li className="footer__teammate">
                            ...
                            <div className="footer__links-wrap">
                                <div className="footer__links">
                                    <a href="https://www.linkedin.com/in/andrea-holstein/" className="footer__links-linkedin">
		...
		C310,145.43,300.549,94.761,230.454,94.761z"/>
                                ...
                                <div className="footer__links">
                                    <a href="https://github.com/andreaholstein/" className="footer__links-github">
